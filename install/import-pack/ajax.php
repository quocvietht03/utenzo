...
if( ! function_exists( 'utenzo_import_pack_modal_import_body_template' ) ) {
    /**
...
if( ! function_exists( 'utenzo_import_pack_download_package' ) ) {
    ...
    function utenzo_import_pack_download_package() {
        ...
        $result = utenzo_import_pack_download_package_step( $package_name, $position, $package );
...
if( ! function_exists( 'utenzo_import_pack_backup_site_substep_install_bears_backup_plg' ) ) {
    ...
    function utenzo_import_pack_backup_site_substep_install_bears_backup_plg() {
        ...
        wp_send_json( [
            ...
            'result' => [
                'status' => true,
                'message' => __( 'Install plugin Bears Backup successful.', 'utenzo' ),
            ]
        ] );
    ...
    function utenzo_import_pack_backup_site_substep_backup_database() {
        ...
        if( $result['success'] == true ) {
            ...
            wp_send_json( [
                ...
                'result' => [
                    'status' => true,
                    'message' => __( 'Backup database successful.', 'utenzo' ),
            ...
            wp_send_json( [
                ...
                'result' => [
                    'status' => false,
                    'message' => __( 'Backup database fail!', 'utenzo' ),
                ]
            ] );
        }
    }
    ...
    function utenzo_import_pack_backup_site_substep_backup_folder_upload() {
        ...
        if( $result['success'] == true ) {
            ...
            wp_send_json( [
                ...
                'result' => [
                    'status' => true,
                    'message' => __( 'Backup folder upload successful.', 'utenzo' ),
                    'next_step_data' => $result,
                ]
            ] );
        } else {
            wp_send_json( [
                ...
                'result' => [
                    'status' => false,
                    'message' => __( 'Backup folder upload fail!', 'utenzo' ),
                ]
            ] );
        }
    }
