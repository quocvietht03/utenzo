...
<?php do_action( 'utenzo/import_pack/demo_install_package/before' ); ?>
...
<div class="ip-package-demo-list">
    ...
    <div class="ip-package-demo-item">
        <div class="preview-image">
            ...
            <div class="actions">
                <a href="<?php echo esc_url( $package_item['url_demo'] ) ?>" target="_blank" class="__action-preview-demo" title="<?php echo esc_attr( 'Preview demo', 'utenzo' ); ?>">
                    <?php _e( 'Preview', 'utenzo' ); ?>
                </a>
                <a href="javascript:" class="__action-import-demo" title="<?php echo esc_attr( 'Import demo', 'utenzo' ); ?>" data-package-id="<?php echo esc_attr( trim( $package_item['package_name'] ) ); ?>">
                    <?php _e( 'Import', 'utenzo' ); ?>
                </a>
            </div>
        </div>
...
<?php do_action( 'utenzo/import_pack/demo_install_package/after' ); ?>
