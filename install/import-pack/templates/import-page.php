...
<div id="Import_Pack_Container">
    ...
    <h1 class="heading-page"><?php echo apply_filters( 'utenzo/import_pack/heading_text', __( 'Utenzo Import Package Demo.', 'utenzo' ) ); ?></h1>

    <?php do_action( 'utenzo/import_pack/before' ); ?>
    ...
    <div class="ip-footer">
        <?php echo apply_filters( 'utenzo/import_pack/footer_text', __( 'Power by Beplus, Thank you creating with Utenzo.', 'utenzo' ) ); ?>
    </div>

    <?php do_action( 'utenzo/import_pack/after' ); ?>
...
<div id="Import_Pack_Modal" class="ip-modal-container">
    <div class="ip-modal">
        <div class="ip-modal-header">
            <a href="javascript:" class="__close" title="<?php echo esc_attr( 'close', 'utenzo' ); ?>">
