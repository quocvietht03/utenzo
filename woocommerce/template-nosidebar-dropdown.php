...
<main id="bt_main" class="bt-site-main">
	<div class="bt-main-content">
		<div class="bt-main-products-ss bt-template-nosidebar-dropdown">
				...
				<div class="bt-main-products-inner">
					<div class="bt-products-topbar">
						...
						<div class="bt-list-tag-filter">
							<a href="#" class="bt-reset-filter-product-btn disable"><?php echo esc_html__('Remove All', 'utenzo') ?>
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
					...
					<div class="bt-product-layout <?php echo ($column_product == 4) ? 'column-4' : ''; ?>" data-view="<?php echo isset($_GET['view_type']) && $_GET['view_type'] != '' ? $_GET['view_type'] : '' ?>">
