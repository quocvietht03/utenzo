...
if (!function_exists('utenzo_post_meta_single_render')) {
  function utenzo_post_meta_single_render()
  {
    ob_start();
...
/* Post Excerpt */
if (!function_exists('utenzo_post_excerpt_render')) {
  function utenzo_post_excerpt_render()
  {
    ob_start();
    ?>
