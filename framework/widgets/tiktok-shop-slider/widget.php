...
class Widget_TikTokShopSlider extends Widget_Base
{
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'video_type',
            [
                'label' => esc_html__('Video Type', 'utenzo'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'upload' => esc_html__('Upload Video', 'utenzo'),
                    'iframe' => esc_html__('TikTok Video', 'utenzo'),
                ],
                'default' => 'url',
                'label_block' => true,
            ]
        ...
        $repeater->add_control(
            'video_upload',
            [
                'label' => esc_html__('Upload Video', 'utenzo'),
                'type' => Controls_Manager::MEDIA,
                'media_type' => 'video',
                'condition' => [
                    'video_type' => 'upload',
        ...
        $repeater->add_control(
            'video_iframe',
            [
                'label' => esc_html__('TikTok Video ID', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Enter TikTok video ID', 'utenzo'),
                'description' => esc_html__('Example: 7449001150021471495', 'utenzo'),
                'condition' => [
                    'video_type' => 'iframe',
                ],
                'label_block' => true,
