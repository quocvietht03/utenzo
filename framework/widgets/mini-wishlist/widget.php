...
namespace UtenzoElementorWidgets\Widgets\MiniWishlist;
...
class Widget_MiniWishlist extends Widget_Base
{
	...
	{
		return __('Mini Wishlist', 'utenzo');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'wishlist_mini_icon',
			[
				'label' => esc_html__('Icon Wishlist', 'utenzo'),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Content Wishlist', 'utenzo'),
		...
		$this->add_control(
			'number_wishlist',
			[
				'label' => __('Number Wishlist', 'utenzo'),
				'type' => Controls_Manager::HEADING,
			]
		);
		$this->add_control(
