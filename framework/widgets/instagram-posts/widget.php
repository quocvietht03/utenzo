...
class Widget_InstagramPosts extends Widget_Base
{
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label' => __('Icon Hover Color', 'utenzo'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'icon_hover_bg_color',
			[
				'label' => __('Icon Hover Background', 'utenzo'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
				...
				<div class="bt-ins-posts--grid">
					<?php foreach ($settings['gallery'] as $item) { ?>
						<div class="bt-ins-posts--image ">
							...
							<a href="<?php echo esc_url($item['url']); ?>" class="bt-icon-view elementor-clickable" data-elementor-lightbox-slideshow="bt-gallery-ins" data-elementor-lightbox-index="<?php echo $item['id']; ?>">
