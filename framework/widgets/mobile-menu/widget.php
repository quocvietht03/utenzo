...
namespace UtenzoElementorWidgets\Widgets\MobileMenu;
...
class Widget_MobileMenu extends Widget_Base
{
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				...
				[
					...
					'description' => sprintf(
						...
						esc_html__( 'Go to the %1$sMenus screen%2$s to manage your menus.', 'utenzo' ),
			...
			$this->add_control(
				...
				[
					...
					'alert_type' => 'info',
					'heading' => esc_html__( 'There are no menus in your site.', 'utenzo' ),
					'content' => sprintf(
						/* translators: 1: Link opening tag, 2: Link closing tag. */
						esc_html__( 'Go to the %1$sMenus screen%2$s to create one.', 'utenzo' ),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Main Menu', 'utenzo'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Sub Menu', 'utenzo'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Additional Options', 'utenzo'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
