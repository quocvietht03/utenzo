...
namespace UtenzoElementorWidgets\Widgets\AccountLogin;
...
class Widget_AccountLogin extends Widget_Base
{
	...
	{
		return __('Account Login', 'utenzo');
	}
		...
		<div class="bt-elwg-account-login">
			<div class="bt-elwg-account-login-inner">
				<?php if (is_user_logged_in()) { ?>
					...
					<div class="bt-account bt-logout">
						<a href="<?php echo esc_url(wp_logout_url()); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
								<g id="User">
							...
							</svg><?php esc_html_e('Sign Out', 'utenzo'); ?></a>
					</div>
				<?php } else { ?>
