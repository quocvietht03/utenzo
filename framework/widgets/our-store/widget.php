<?php
namespace UtenzoElementorWidgets\Widgets\OurStore;
...
class Widget_OurStore extends Widget_Base
{
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'name',
            [
                'label' => __('Store Name', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Store Name', 'utenzo'),
            ]
        );
        $repeater->add_control(
            'position',
            [
                'label' => __('Location', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Store Location', 'utenzo'),
            ]
        );
        $repeater->add_control(
            'facebook',
            [
                'label' => __('Facebook URL', 'utenzo'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://facebook.com', 'utenzo'),
            ]
        );
        $repeater->add_control(
            'twitter',
            [
                'label' => __('Twitter URL', 'utenzo'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://twitter.com', 'utenzo'),
            ]
        );
        $repeater->add_control(
            'pinterest',
            [
                'label' => __('Pinterest URL', 'utenzo'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://pinterest.com', 'utenzo'),
            ]
        );
        $repeater->add_control(
            'instagram',
            [
                'label' => __('Instagram URL', 'utenzo'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://instagram.com', 'utenzo'),
            ]
        );
        $this->add_control(
            'store_list',
            [
                'label' => __('Store List', 'utenzo'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'name' => __('Store #1', 'utenzo'),
                        'position' => __('Location 1', 'utenzo'),
                    ],
                    [
                        'name' => __('Store #2', 'utenzo'),
                        'position' => __('Location 2', 'utenzo'),
                    ],
                ],
                'title_field' => '{{{ name }}}',
            ]
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bt-store-list' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bt-store-list' => 'grid-column-gap: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bt-store-list' => 'grid-row-gap: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bt-store-list .bt-store-item .bt-store-info .bt-store-name' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bt-store-list .bt-store-item .bt-store-info .bt-store-name',
            ]
        );
        $this->add_responsive_control(
            'name_spacing',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bt-store-list .bt-store-item .bt-store-info .bt-store-name' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bt-store-list .bt-store-item .bt-store-info .bt-store-location' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bt-store-list .bt-store-item .bt-store-info .bt-store-location',
            ]
        );
        $this->end_controls_section();
    }
