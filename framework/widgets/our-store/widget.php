...
class Widget_OurStore extends Widget_Base
{
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'address',
            [
                'label' => __('Address', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'default' => __('123 Street Name, City, Country', 'utenzo'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'phone',
            [
                'label' => __('Phone', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'default' => __('+1 234 567 890', 'utenzo'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('store@example.com', 'utenzo'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            'direction_text',
            [
                'label' => __('Direction Button Text', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Get Directions', 'utenzo'),
                'placeholder' => __('Enter button text', 'utenzo'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            'direction_url',
            [
                'label' => __('Direction URL', 'utenzo'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://maps.google.com/?q=...', 'utenzo'),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
            'info_heading',
            [
                'label' => __('Store Information', 'utenzo'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'direction_heading',
            [
                'label' => __('Direction Button', 'utenzo'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
                        ...
                        <div class="bt-store--item">
                            ...
                            <div class="bt-store--info">
                                ...
                                <?php if (!empty($store['direction_url']['url']) && !empty($store['direction_text'])) : ?>
                                    <a href="<?php echo esc_url($store['direction_url']['url']); ?>" class="bt-store--direction" <?php echo $store['direction_url']['is_external'] ? 'target="_blank"' : ''; ?>>
