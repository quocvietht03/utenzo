...
namespace UtenzoElementorWidgets\Widgets\SearchProduct;
...
class Widget_SearchProduct extends Widget_Base
{
	...
	{
		return __('Search Product', 'utenzo');
	}
	...
	protected function register_query_section_controls()
	{
		...
		$this->add_control(
			'placeholder_text',
			[
				'label' => __('Placeholder Text', 'utenzo'),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __('What are you looking for today?', 'utenzo'),
				'placeholder' => __('Enter placeholder text', 'utenzo'),
			]
		);
		$this->add_control(
			'enable_autocomplete',
			[
				'label' => __('Enable Autocomplete', 'utenzo'),
					...
					<div class="bt-search--category">
						<div class="bt-category-dropdown">
							<div class="bt-selected-category">
								<span><?php echo !empty($current_cat) ? esc_html(get_term_by('slug', $current_cat, 'product_cat')->name) : esc_html__('All', 'utenzo'); ?></span>
							...
							<ul class="bt-category-list" style="display: none;">
								...
								echo '<a href="#">' . esc_html__('All', 'utenzo') . '</a>';
								echo '</li>';
