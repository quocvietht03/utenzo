...
namespace UtenzoElementorWidgets\Widgets\HeadingAnimation;
...
class Widget_HeadingAnimation extends Widget_Base
{
	...
	{
		return __('Heading Animation', 'utenzo');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'animation_text',
			[
				'label'       => esc_html__('Heading Animation', 'utenzo'),
				'type'        => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'default'     => esc_html__('Animation', 'utenzo'),
			]
		);
		...
		$this->add_control(
			'entrance_animation',
			[
				'label' => esc_html__( 'Entrance Animation', 'utenzo' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none' => esc_html__( 'None', 'utenzo' ),
					'bt-animation-right' => esc_html__( 'Fade In Right', 'utenzo' ),
					'bt-animation-left' => esc_html__( 'Fade In Left', 'utenzo' ),
					'bt-animation-up' => esc_html__( 'Fade In Up', 'utenzo' ),
					'bt-animation-down' => esc_html__( 'Fade In Down', 'utenzo' ),
					'bt-animation-zoom' => esc_html__( 'Zoom In', 'utenzo' ),
				],
			]
		);
		$this->add_responsive_control(
			'animation_delay',
			[
				'label' => __('Animation Delay (ms)', 'utenzo'),
