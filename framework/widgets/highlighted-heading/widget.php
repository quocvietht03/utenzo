...
namespace UtenzoElementorWidgets\Widgets\HighlightedHeading;
...
class Widget_HighlightedHeading extends Widget_Base
{
	...
	{
		return __('Highlighted Heading', 'utenzo');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'before_text',
			[
				'label'       => esc_html__('Before Text', 'utenzo'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('This is the heading', 'utenzo'),
			]
		);
		...
		$this->add_control(
			'highlighted_text',
			[
				'label'       => esc_html__('Highlighted Text', 'utenzo'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Highlighted', 'utenzo'),
			]
		);
		...
		$this->add_control(
			'after_text',
			[
				'label'       => esc_html__('After Text', 'utenzo'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '',
			]
