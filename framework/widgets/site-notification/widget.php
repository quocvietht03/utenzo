...
namespace UtenzoElementorWidgets\Widgets\SiteNotification;
...
class Widget_SiteNotification extends Widget_Base
{
    ...
    {
        return __('Site Notification', 'utenzo');
    }
    ...
    protected function register_layout_section_controls()
    {
        $this->start_controls_section(
            'section_slider',
            [
                'label' => __('Notification', 'utenzo'),
            ]
        );
        $this->add_control(
            'slider_autoplay',
            [
                'label' => __('Notification Autoplay', 'utenzo'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Notification Delay', 'utenzo'),
                'type' => Controls_Manager::NUMBER,
                'default' => 3000,
                'min' => 1000,
                'max' => 10000,
                'step' => 500,
                'description' => __('Delay between notification in milliseconds', 'utenzo'),
                'condition' => [
                    'slider_autoplay' => 'yes',
                ],
            ]
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
            'link_hover_color',
            [
                'label' => __('Link Hover Color', 'utenzo'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'text_align',
            [
                'label' => __('Alignment', 'utenzo'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'utenzo'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'utenzo'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'utenzo'),
