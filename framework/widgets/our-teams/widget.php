...
namespace UtenzoElementorWidgets\Widgets\OurTeams;
...
class Widget_OurTeams extends Widget_Base
{
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'image',
            [
                'label' => __('Team Member Image', 'utenzo'),
        ...
        $repeater->add_control(
            'position',
            [
                'label' => __('Position', 'utenzo'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Developer', 'utenzo'),
            ]
        );
        ...
        $this->add_control(
            'team_members',
            [
                'label' => __('Team Members', 'utenzo'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'name' => __('Team Member #1', 'utenzo'),
                        'position' => __('Developer', 'utenzo'),
                    ],
                    [
                        'name' => __('Team Member #2', 'utenzo'),
                        'position' => __('Designer', 'utenzo'),
                    ],
                ],
                'title_field' => '{{{ name }}}',
            ]
