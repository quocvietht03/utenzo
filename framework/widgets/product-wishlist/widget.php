...
namespace UtenzoElementorWidgets\Widgets\ProductWishlist;
...
class Widget_ProductWishlist extends Widget_Base
{
	...
	{
		return __('Product Wishlist', 'utenzo');
	}
	...
	public function post_social_share()
	{
		...
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-google-plus" data-toggle="tooltip" title="' . esc_attr__('Google Plus', 'utenzo') . '" href="https://plus.google.com/share?url=' . get_the_permalink() . '">
		...
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-pinterest" data-toggle="tooltip" title="' . esc_attr__('Pinterest', 'utenzo') . '" href="https://pinterest.com/pin/create/button/?url=' . get_the_permalink() . '">
...
?>
		<div class="bt-post-share">
			...
			if (!empty($social_item)) {
				echo '<span>' . esc_html__('Share: ', 'utenzo') . '</span><ul>' . implode(' ', $social_item) . '</ul>';
			}
			?>
		</div>
	<?php
					...
					<div class="bt-table--head">
						<div class="bt-table--row">
							<div class="bt-table--col bt-product-remove">
								<?php echo '<span>' . __('Remove', 'utenzo') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-thumb">
								<?php echo '<span>' . __('Thumbnail', 'utenzo') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-title">
								<?php echo '<span>' . __('Product Name', 'utenzo') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-price">
								<?php echo '<span>' . __('Price', 'utenzo') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-stock">
								<?php echo '<span>' . __('Stock status', 'utenzo') . '</span>'; ?>
							</div>
						...
						<?php } else { ?>
							<div class="bt-product-list">
								<div class="bt-no-results">
									<?php echo __('No products found!', 'utenzo'); ?>
									<a href="/shop/"><?php echo __('Back to Shop', 'utenzo'); ?></a>
								</div>
							</div>
						<?php } ?>
					</div>
