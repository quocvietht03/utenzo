...
namespace UtenzoElementorWidgets\Widgets\ProductCategoryStyle1;
...
class Widget_ProductCategoryStyle1 extends Widget_Base
{
	...
	{
		return __('Product Category Style 1', 'utenzo');
	}
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'image_style',
			[
				'label' => __('Image Style', 'utenzo'),
				'type' => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'normal' => __('Normal Image', 'utenzo'),
					'transparent' => __('Transparent Image', 'utenzo'),
				],
			]
		);
						...
						<div class="bt-product-category--item">
							<a class="bt-product-category--inner" href="<?php echo esc_url($category_url); ?>">
								...
								<div class="bt-product-category--count">
									...
									echo esc_html($product_count) . ' ' . ($product_count > 1 ? __('items', 'utenzo') : __('item', 'utenzo'));
									?>
								</div>
							</a>
						</div>
